...
SORTING_ORDER = ['A', 'K', 'Q', 'T', '9', '8', '7', '6', '5', '4', '3', '2', 'J']
...
if __name__ == "__main__":
    ...
    for hand_type, hands_and_bids in hands_per_type.items():
        ...
        # print([(ranks[alpha_hand], hand, bid) for hand, bid, alpha_hand in hands_and_bids])
    ...
    print(total) # correct: 251195607. Mine: 252152315
